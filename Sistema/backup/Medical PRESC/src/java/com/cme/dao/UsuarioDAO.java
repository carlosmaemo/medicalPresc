...
public class UsuarioDAO {
    ...
    public void actualizar(Usuario usuario, Integer idUsuario) throws ErroSistema {
        ...
        try {
            ...
            ps = conexao.prepareStatement("update usuario set nomeUsuario=?, password=?, sexo=?, contacto=?, morada=? where idUsuario=?");
    ...
    public void salvar(Usuario usuario) throws ErroSistema {
        ...
        try {
            ...
            ps = conexao.prepareStatement("INSERT INTO `usuario`(`nomeUsuario`, `username`, `password`, `acesso`, `sexo`, `contacto`, `morada`) VALUES (?, ?, ?, ?, ?, ?, ?)");
    ...
    public List<Usuario> buscar() throws ErroSistema {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                usuario.setMorada(rs.getString("morada"));
    ...
    public String verificarContacto(Usuario usuario) throws ErroSistema {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                String x = rs.getString("contacto");
