...
public class Prescricao {
    ...
    private boolean actualizarReg = false;

    private int ordem;

    private String data, clinico, clinicoMorada, clinicoContacto;
    ...
    public Boolean getActualizarReg() {
        return actualizarReg;
    }

    public void setActualizarReg(boolean actualizarReg) {
